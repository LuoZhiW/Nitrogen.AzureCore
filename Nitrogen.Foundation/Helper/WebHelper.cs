...
namespace Nitrogen.Foundation.Helper
{
    public  class WebHelper
    {
        ...
        public  string Host
        {
            get
            {
                return _HttpContext.HttpContext.Request.PathBase.Value;
            }
        }
        #endregion
        ...
        public  void WriteSession(string key, string value)
        {
            if (key.IsEmpty())
                return;
            _HttpContext.HttpContext.Session.Set(key, value);
        }
        ...
        {
            var cookie = _HttpContext.HttpContext.Request.Cookies[strName];
            if (cookie == null)
            {
               // cookie = new HttpCookie(strName);
            }
            _HttpContext.HttpContext.Response.Cookies.Append(strName,strValue);
        }
        /// <summary>
        /// 写cookie值
        /// </summary>
        ...
        public void WriteCookie(string strName, string strValue, int expires)
        {
            ...
            var _expires = DateTime.Now.AddMinutes(expires);
            _HttpContext.HttpContext.Response.Cookies.Append(strName, strValue, new CookieOptions() { Expires = _expires });
        }
        /// <summary>
        /// 读cookie值
        /// </summary>
        ...
        {
            if (_HttpContext.HttpContext.Request.Cookies != null && _HttpContext.HttpContext.Request.Cookies[strName] != null)
            {
                return _HttpContext.HttpContext.Request.Cookies[strName].ToString();
            }
            return "";
        }
        /// <summary>
        ...
        {
            _HttpContext.HttpContext.Response.Cookies.Delete(CookiesName);
        }
        #endregion
